...
[배포처 바로가기](https://blog.naver.com/hp0/222617179709)

&nbsp;

## 웹 폰트

사용하는 `font-family`의 이름은 `HSSantokki`입니다.
...
@font-face {
    ...
    src: url('https://cdn.jsdelivr.net/gh/fonts-archive/HSSantokki/HSSantokki.woff2') format('woff2'),
         ...
         url('https://cdn.jsdelivr.net/gh/fonts-archive/HSSantokki/HSSantokki.otf') format('opentype'),
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/HSSantokki/subsets/HSSantokki-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/HSSantokki/subsets/HSSantokki-dynamic-subset.css');
```
...
```css
font-family: "HSSantokki", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
